---
title: " Impact of Return Policy Change"
author: "Mishita Agarwal"
date: "3/15/2018"
...
```{r}
setwd("C:/Users/biyani/Downloads")
```
...
cor(df)
vif(df) #VIF scores all < 3. I had to remove variables such as month_index and store_average_price because they generated VIF scores > 3.
...
#From the interaction term, it can be concluded that physical stores who changed their policy from 90 to 45 days return saw a reduction in return amount of 42.5% due to the policy change.
```
